...
const gridanimation = () => {
    return (
        <div className='gridContainer  py-10 '>
            <div className='item item-1 flex flex-col lg:flex-row rounded-xl overflow-hidden shadow-lg'>
                <img src={depression} alt="depression" />
                <div className='flex justify-start items-center flex-col p-10 gap-4'>
            ...
            <div className='item item-2 flex flex-col rounded-xl overflow-hidden shadow-lg'>
            ...
            <div className='item item-3 flex flex-col lg:flex-row rounded-xl overflow-hidden shadow-lg'>
                <div className='flex justify-center  flex-col gap-2 p-2'>
                    <h1 className='text-2xl font-semibold text-center'>Anxiety</h1>
                    <p className='text-sm text-center'>we take pride in the positive impact our online have on our client’s lives. </p>
                </div>
            ...
            <div className='item item-4 flex flex-col rounded-xl overflow-hidden shadow-lg '>
            ...
            <div className='item item-5 flex flex-col lg:flex-row rounded-xl overflow-hidden shadow-lg'>
